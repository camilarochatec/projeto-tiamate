  ...
  return (
    <section className="bg-[#e7e1df] w-full flex flex-col items-center py-10 px-4 gap-8">
      ...
      >
        ...
        <h3 className="text-[50px] md:text-3xl font-bold text-[#a97744]">
          Cardápio
        </h3>
      </motion.div>
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.95 }}
      >
        <button className="bg-[#cf9a5a] border-0 px-[152px] py-[16px] text-[18px] rounded hover:brightness-110 transition-all duration-300">
          Ver mais
        </button>
      </motion.div>
    </section>
