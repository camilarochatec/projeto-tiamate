...
const Modelo = () => {
  return (
    <div className="bg-[#f0e9e4] py-10 md:py-16 px-4 text-center">
      {/* Layout MOBILE (default): texto em cima */}
      {/* Layout DESKTOP (md+): flex horizontal */}
      <div className="flex flex-col md:flex-row justify-center items-center">

        {/* Imagem da esquerda (visível só no md+) */}
        ...
        {/* Imagem da direita (visível só no md+) */}
      ...
      {/* Imagens lado a lado no mobile (visíveis só em < md) */}
