            ...
            <div className="grid lg:grid-cols-3 gap-24 py-20 leading-tight">
                <div className="max-w-sm text-center lg:text-left ">
                    <div className="mb-2">
                        ...
                        <h3 className="text-marrom text-xl font-bold">Salvador Centro - BA</h3>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex gap-4">
                            ...
                            <p>
                                ...
                                (loja 68) <span className="text-bege font-bold">Cep:</span> 70770-560</p>
                        </div>
                        <div className="flex gap-4">
                        ...
                        <div className="flex gap-4">
                            ...
                            <p>
                                <span className="text-bege font-bold">Contato:</span> (85) 99691-7642
                            </p>
                        </div>
                    </div>
                </div>
